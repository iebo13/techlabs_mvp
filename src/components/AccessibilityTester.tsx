...
import { Alert, Box, Button, Collapse, List, ListItem, ListItemText, Typography } from '@mui/material'
                        ...
                        <List dense sx={{ maxHeight: 300, overflow: 'auto' }}>
                            {issues.map((issue) => (
                                <ListItem
                                    ...
                                    sx={{
                                        border: '1px solid',
                                        borderColor: issue.type === 'error' ? 'error.main' :
                                            issue.type === 'warning' ? 'warning.main' : 'info.main',
                                        borderRadius: 1,
                                        mb: 1,
                                        cursor: 'pointer',
                                    }}
                                >
                                    <ListItemText
                                        ...
                                        primaryTypographyProps={{
                                            variant: 'body2',
                                            color: issue.type === 'error' ? 'error.main' :
                                                issue.type === 'warning' ? 'warning.main' : 'info.main',
                                        }}
