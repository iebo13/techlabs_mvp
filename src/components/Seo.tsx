...
export const SEO: React.FC<SEOProps> = ({
    ...
    useEffect(() => {
        ...
        const ogTags = [
            ...
            { property: 'og:url', content: url ? `${window.location.origin}${url}` : window.location.href },
        ...
        canonicalLink.setAttribute('href', url ? `${window.location.origin}${url}` : window.location.href)
