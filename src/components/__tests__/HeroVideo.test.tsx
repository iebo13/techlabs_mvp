...
describe('HeroVideo', () => {
    ...
    it('formats duration correctly for different values', () => {
        ...
        rerender(<ThemeProvider theme={theme}><HeroVideo {...defaultProps} duration={125} /></ThemeProvider>)
        expect(screen.getByText('02:05')).toBeInTheDocument()

        rerender(<ThemeProvider theme={theme}><HeroVideo {...defaultProps} duration={9} /></ThemeProvider>)
