...
describe('WhyTechlabs', () => {
    it('renders section heading', () => {
        ...
        expect(screen.getByText('Discover what makes our programs unique and effective')).toBeInTheDocument()
    })
    ...
    it('renders card descriptions', () => {
        ...
        expect(screen.getByText('Build projects and a portfolio that accelerate your job search.')).toBeInTheDocument()
    })
