      ...
      <Container maxWidth="lg" sx={{ py: 6 }}>
        ...
        <Box sx={{ mb: 4 }}>
          <Tabs
            ...
            variant="fullWidth"
            aria-label={t('events.tabs.filterLabel', { defaultValue: 'Filter events by status' })}
            sx={{
              '& .MuiTab-root': {
                fontSize: '1rem',
                fontWeight: 600,
            ...
            <Tab value="all" label={getTabLabel('all')} id="events-tab-all" aria-controls="events-tabpanel-all" />
            <Tab
              value="upcoming"
              label={getTabLabel('upcoming')}
              id="events-tab-upcoming"
              aria-controls="events-tabpanel-upcoming"
            />
            <Tab value="past" label={getTabLabel('past')} id="events-tab-past" aria-controls="events-tabpanel-past" />
          </Tabs>
        </Box>
